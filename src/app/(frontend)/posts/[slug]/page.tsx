    ...
    <article className="pb-16 pt-16">
      ...
      <div className="flex flex-col items-center gap-4 pt-8">
        <div className="container">
          ...
          {post.relatedPosts && post.relatedPosts.length > 0 && <RelatedPosts className="col-span-3 col-start-1 mt-12 max-w-[52rem] grid-rows-[2fr] lg:grid lg:grid-cols-subgrid" docs={post.relatedPosts.filter(post => typeof post === 'object')} />}
        </div>
      </div>
    </article>
  );
